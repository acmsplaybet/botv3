...
### 🟡 FAZ 4: APEX CANLI API SENKRONİZASYONU & CRON OTOMASYONU (PLANLANDI)
- [ ] **Adım 4.1: APEX Ingestion Endpoint Güncellemesi** → `core/db_ingester.js` üzerinden `http://localhost/apex-api/api/import.php` bağlantısı.
